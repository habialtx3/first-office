...
export default function CheckBooking() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Cari booking di mock data
    const foundBooking = mockBookings.find(
      (b) =>
        b.booking_trx_id === formData.booking_trx_id &&
        b.phone_number.toString() === formData.phone_number
    );
            ...
            <div className="flex flex-col h-fit shrink-0 rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
              <div className="flex items-center gap-4">
                <div className="flex shrink-0 w-[140px] h-[100px] rounded-[20px] overflow-hidden">
                  <img src={bookingDetails.office.thumbnail} className="w-full h-full object-cover" alt="thumbnail" />
                </div>
